...
tmux send-keys -t ros_session:1 'sleep 5; source ~/first_task_ws/devel/setup.bash; rosrun mission laser_to_worldframe' C-m

tmux split-window -h -t ros_session:1
tmux send-keys -t ros_session:1.1 'sleep 5; source ~/first_task_ws/devel/setup.bash; roslaunch mission ego_planner_mid360.launch' C-m
...
tmux send-keys -t ros_session:2.1 'sleep 7; source ~/first_task_ws/devel/setup.bash; roslaunch flight_mission flight_mission.launch' C-m
